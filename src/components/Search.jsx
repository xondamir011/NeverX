...
//   return (
//     <div className="w-full max-w-7xl mx-auto px-3 sm:px-5 py-3">
...
//           className="flex-1 input input-bordered input-primary rounded-2xl h-12"
//           value={query}
...
//           className="btn btn-primary rounded-2xl h-12 px-4"
//         >
//           <SearchIcon size={18} />
//         </button>
...
//       {/* CINEMA BANNER */}
//       <div className="relative overflow-hidden rounded-[35px] h-[270px] sm:h-[430px] group">
...
//             <button className="w-12 h-12 rounded-full border border-base-content/20 flex items-center justify-center backdrop-blur-md bg-base-100/20 text-base-content hover:scale-110 transition-all">
//               <Volume2 size={20} />
//             </button>
...
//               {[active.year, active.country, active.genre, active.age].map(
//                 (i) => (
//                   <span
//                     key={i}
...
//               {active.desc[currentLang] || active.desc.UZ}
//             </p>

//             <button className="mt-6 bg-primary hover:opacity-90 transition-all text-primary-content font-bold px-8 sm:px-14 py-4 rounded-full flex items-center gap-2 hover:scale-105 shadow-xl">
